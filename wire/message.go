...
type Message interface {
	PinDecode(io.Reader, uint32, MessageEncoding) error
	PinEncode(io.Writer, uint32, MessageEncoding) error
	Command() string
...
func WriteMessageN(w io.Writer, msg Message, pver uint32, btcnet PinNet) (int, error) {
...
func WriteMessage(w io.Writer, msg Message, pver uint32, btcnet PinNet) error {
...
func WriteMessageWithEncodingN(w io.Writer, msg Message, pver uint32,
	btcnet PinNet, encoding MessageEncoding) (int, error) {
	...
	var bw bytes.Buffer
	err := msg.PinEncode(&bw, pver, encoding)
	if err != nil {
...
func ReadMessageWithEncodingN(r io.Reader, pver uint32, btcnet PinNet,
	...
	// MsgVersion PinDecode function requires it.
	pr := bytes.NewBuffer(payload)
	err = msg.PinDecode(pr, pver, enc)
	if err != nil {
		return totalBytes, nil, nil, err
	}
...
func ReadMessageN(r io.Reader, pver uint32, btcnet PinNet) (int, Message, []byte, error) {
...
func ReadMessage(r io.Reader, pver uint32, btcnet PinNet) (Message, []byte, error) {
