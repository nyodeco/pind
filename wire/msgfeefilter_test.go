...
func TestFeeFilterLatest(t *testing.T) {
	...
	err := msg.PinEncode(&buf, pver, BaseEncoding)
	if err != nil {
	...
	err = readmsg.PinDecode(&buf, pver, BaseEncoding)
	if err != nil {
...
func TestFeeFilterWire(t *testing.T) {
	...
	for i, test := range tests {
		...
		var buf bytes.Buffer
		err := test.in.PinEncode(&buf, test.pver, BaseEncoding)
		if err != nil {
		...
		err = msg.PinDecode(rbuf, test.pver, BaseEncoding)
		if err != nil {
...
func TestFeeFilterWireErrors(t *testing.T) {
	...
	for i, test := range tests {
		...
		err := test.in.PinEncode(w, test.pver, BaseEncoding)
		...
		err = msg.PinDecode(r, test.pver, BaseEncoding)
