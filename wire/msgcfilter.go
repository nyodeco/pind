...
func (msg *MsgCFilter) PinDecode(r io.Reader, pver uint32, _ MessageEncoding) error {
	// Read filter type
...
// from PinDecode in that PinDecode decodes from the bitcoin wire protocol as
