...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*pinutil.Block, error) {
	...
	blocks := make([]*pinutil.Block, 0, 256)
	genesis := pinutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
