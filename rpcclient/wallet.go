...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []pinutil.Address) FutureListUnspentResult {
...
func (c *Client) SetTxFee(fee pinutil.Amount) error {
...
func (c *Client) SendToAddress(address pinutil.Address, amount pinutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address pinutil.Address,
	amount pinutil.Amount, comment,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address pinutil.Address, amount pinutil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress pinutil.Address, amount pinutil.Amount) (*chainhash.Hash, error) {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress pinutil.Address, amount pinutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress pinutil.Address, amount pinutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress pinutil.Address,
	amount pinutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[pinutil.Address]pinutil.Amount) FutureSendManyResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[pinutil.Address]pinutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[pinutil.Address]pinutil.Amount,
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[pinutil.Address]pinutil.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (pinutil.Address, error) {
	...
	return pinutil.DecodeAddress(addr, r.network)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []pinutil.Address, account string) FutureAddMultisigAddressResult {
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []pinutil.Address, account string) (pinutil.Address, error) {
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []pinutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}
...
// address.
func (r FutureGetNewAddressResult) Receive() (pinutil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
// chain params.
func (c *Client) GetNewAddress(account string) (pinutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (pinutil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddress(account string) (pinutil.Address, error) {
...
// address.
func (r FutureAddWitnessAddressResult) Receive() (pinutil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) AddWitnessAddress(address string) (pinutil.Address, error) {
...
func (r FutureGetAccountAddressResult) Receive() (pinutil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddress(account string) (pinutil.Address, error) {
...
func (c *Client) GetAccount(address pinutil.Address) (string, error) {
...
func (c *Client) SetAccount(address pinutil.Address, account string) error {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]pinutil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
	...
	addresses := make([]pinutil.Address, len(addrStrings))
	for i, addrString := range addrStrings {
		addresses[i], err = pinutil.DecodeAddress(addrString, r.network)
		if err != nil {
			return nil, err
		}
	}
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]pinutil.Address, error) {
...
func (c *Client) Move(fromAccount, toAccount string, amount pinutil.Amount) (bool, error) {
...
func (c *Client) MoveMinConf(fromAccount, toAccount string, amount pinutil.Amount, minConf int) (bool, error) {
...
func (c *Client) MoveComment(fromAccount, toAccount string, amount pinutil.Amount,
...
func (r FutureListAccountsResult) Receive() (map[string]pinutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]pinutil.Amount)
	for k, v := range accounts {
		amount, err := pinutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccounts() (map[string]pinutil.Amount, error) {
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]pinutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (pinutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := pinutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (pinutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetBalance(account string) (pinutil.Amount, error) {
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (pinutil.Amount, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (pinutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (pinutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (pinutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (pinutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalance(account string) (pinutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (pinutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAddress(address pinutil.Address) (pinutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConf(address pinutil.Address, minConfirms int) (pinutil.Amount, error) {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address pinutil.Address, message string) (string, error) {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address pinutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*pinutil.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return pinutil.DecodeWIF(privKeyWIF)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address pinutil.Address) (*pinutil.WIF, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *pinutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
...
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *pinutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *pinutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *pinutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *pinutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *pinutil.WIF, label string, rescan bool) error {
...
// NOTE: While getinfo is implemented here (in wallet.go), a pind chain server
