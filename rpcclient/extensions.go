...
//
// NOTE: This is a pind extension.
func (c *Client) DebugLevelAsync(levelSpec string) FutureDebugLevelResult {
	cmd := pinjson.NewDebugLevelCmd(levelSpec)
...
func (r FutureListAddressTransactionsResult) Receive() ([]pinjson.ListTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
//
// NOTE: This is a pind extension.
func (c *Client) ListAddressTransactionsAsync(addresses []pinutil.Address, account string) FutureListAddressTransactionsResult {
	// Convert addresses to strings.
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.EncodeAddress())
	}
	cmd := pinjson.NewListAddressTransactionsCmd(addrs, &account)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a pinwallet extension.
func (c *Client) ListAddressTransactions(addresses []pinutil.Address, account string) ([]pinjson.ListTransactionsResult, error) {
...
func (r FutureGetBestBlockResult) Receive() (*chainhash.Hash, int32, error) {
	...
	var bestBlock pinjson.GetBestBlockResult
...
func (c *Client) GetBestBlockAsync() FutureGetBestBlockResult {
	cmd := pinjson.NewGetBestBlockCmd()
	return c.sendCmd(cmd)
}
...
func (r FutureGetCurrentNetResult) Receive() (wire.PinNet, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetCurrentNetAsync() FutureGetCurrentNetResult {
	cmd := pinjson.NewGetCurrentNetCmd()
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a pind extension.
func (c *Client) GetCurrentNet() (wire.PinNet, error) {
...
func (c *Client) GetHeadersAsync(blockLocators []chainhash.Hash, hashStop *chainhash.Hash) FutureGetHeadersResult {
	...
	cmd := pinjson.NewGetHeadersCmd(locators, hash)
	return c.sendCmd(cmd)
}
...
func (c *Client) ExportWatchingWalletAsync(account string) FutureExportWatchingWalletResult {
	cmd := pinjson.NewExportWatchingWalletCmd(&account, pinjson.Bool(true))
	return c.sendCmd(cmd)
}
...
// used by pinwallet to enable a wallet which does not have the private keys
...
// Receive waits for the response promised by the future and returns the
// session result.
func (r FutureSessionResult) Receive() (*pinjson.SessionResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var session pinjson.SessionResult
...
//
// NOTE: This is a btcsuite extension.
func (c *Client) Session() (*pinjson.SessionResult, error) {
...
// NOTE: This is a btcsuite extension ported from
// github.com/decred/dcrrpcclient.
func (r FutureVersionResult) Receive() (map[string]pinjson.VersionResult,
	error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	...
	var vr map[string]pinjson.VersionResult
...
// NOTE: This is a btcsuite extension ported from
// github.com/decred/dcrrpcclient.
func (c *Client) Version() (map[string]pinjson.VersionResult, error) {
