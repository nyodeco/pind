...
func (s *SigCache) Exists(sigHash chainhash.Hash, sig *pinec.Signature, pubKey *pinec.PublicKey) bool {
	s.RLock()
...
func (s *SigCache) Add(sigHash chainhash.Hash, sig *pinec.Signature, pubKey *pinec.PublicKey) {
	s.Lock()
	defer s.Unlock()
