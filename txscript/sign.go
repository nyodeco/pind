...
type KeyDB interface {
	GetKey(pinutil.Address) (*btcec.PrivateKey, bool, error)
}

// KeyClosure implements KeyDB with a closure.
type KeyClosure func(pinutil.Address) (*btcec.PrivateKey, bool, error)

// GetKey implements KeyDB by returning the result of calling the closure.
func (kc KeyClosure) GetKey(address pinutil.Address) (*btcec.PrivateKey,
	bool, error) {
	return kc(address)
}
