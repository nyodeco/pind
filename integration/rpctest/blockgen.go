...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr pinutil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*pinutil.Tx, error) {
...
func CreateBlock(prevBlock *pinutil.Block, inclusionTxs []*pinutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr pinutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*pinutil.Block, error) {
	...
	blockTxns := []*pinutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := pinutil.NewBlock(&block)
