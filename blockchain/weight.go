...
func GetBlockWeight(blk *pinutil.Block) int64 {
...
func GetTransactionWeight(tx *pinutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *pinutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
