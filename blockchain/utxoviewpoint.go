...
func (view *UtxoViewpoint) AddTxOut(tx *pinutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *pinutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *pinutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *pinutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *pinutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *pinutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *pinutil.Tx) (*UtxoViewpoint, error) {
