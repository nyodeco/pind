...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*pinutil.Tx, witness bool) []*chainhash.Hash {
...
func ExtractWitnessCommitment(tx *pinutil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *pinutil.Block) error {
