...
func dbIndexConnectBlock(dbTx database.Tx, indexer Indexer, block *pinutil.Block,
...
func dbIndexDisconnectBlock(dbTx database.Tx, indexer Indexer, block *pinutil.Block,
	stxo []blockchain.SpentTxOut) error {
...
//
// This is part of the blockchain.IndexManager interface.
func (m *Manager) ConnectBlock(dbTx database.Tx, block *pinutil.Block,
...
//
// This is part of the blockchain.IndexManager interface.
func (m *Manager) DisconnectBlock(dbTx database.Tx, block *pinutil.Block,
	stxo []blockchain.SpentTxOut) error {
