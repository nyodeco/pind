...
func storeFilter(dbTx database.Tx, block *pinutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *pinutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *pinutil.Block,
