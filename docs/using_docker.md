...
With Docker you can easily set up *btcd* to run your Bitcoin full node. You can find the official *btcd* Docker images on Docker Hub [nyodeco/pind](https://hub.docker.com/r/nyodeco/pind). The Docker source file of this image is located at [Dockerfile](https://github.com/nyodeco/pind/blob/master/Dockerfile).
