...
* Download the Conformal public key:
  https://raw.githubusercontent.com/nyodeco/pind/master/release/GIT-GPG-KEY-conformal.txt
...
* [Using bootstrap.dat](https://github.com/nyodeco/pind/blob/master/docs/configuration.md#using-bootstrapdat)
