...
reason, the pind suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire pind
...
One of the major design goals of all core pind packages is to aim for complete
...
commits](https://github.com/nyodeco/pind/commits/master) for examples of
commit messages.
...
contributions.  This is how to get your changes into pind.
...
Rejoice as you will now be listed as a [contributor](https://github.com/nyodeco/pind/graphs/contributors)!
...
[ISC license](https://github.com/nyodeco/pind/blob/master/LICENSE).  This is
the same license as all of the code in the pind suite.
