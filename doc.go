...
/*
pind is a full-node bitcoin implementation written in Go.

The default options are sane for most users.  This means pind will work 'out of
...
parsed when pind starts up.  By default, the configuration file is located at
~/.pind/pind.conf on POSIX-style operating systems and %LOCALAPPDATA%\pind\pind.conf
