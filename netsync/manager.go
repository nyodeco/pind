...
import (
	...
	peerpkg "github.com/nyodeco/pind/peer"
...
func (sm *SyncManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*pinutil.Block)
		if !ok {
...
// processed.
func (sm *SyncManager) QueueTx(tx *pinutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *pinutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *pinutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
