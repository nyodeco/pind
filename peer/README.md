...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/nyodeco/pind/peer)
...
```bash
$ go get -u github.com/nyodeco/pind/peer
```

## Examples

* [New Outbound Peer Example](https://pkg.go.dev/github.com/nyodeco/pind/peer#example-package--NewOutboundPeer)  
